...
* Setting up subscriptions (websockets(webservices){realtime communication or bidirectional communications (typing ... in whatsapp)})*/
...
export function UseEffectBasics() {
    ...
    useEffect(() => {
        console.log(`Count changed tp ${count}`);
    }, [count]);
