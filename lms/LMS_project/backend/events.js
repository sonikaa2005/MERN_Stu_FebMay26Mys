...
emitter.on("adminLogin", (username) => {
  console.log(chalk.magenta(`Admin logged in: ${username}`));
});

emitter.on("adminLogout", (username) => {
  console.log(chalk.magenta(`Admin logged out: ${username}`));
});
