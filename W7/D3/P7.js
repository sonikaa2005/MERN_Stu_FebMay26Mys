...
const userToken = jwt.sign({ userId: 1, role: "user", email: "user@email.com" }, secretKey, { expiresIn: "1h" });
console.log("Usertoken:", userToken);
const adminToken = jwt.sign({ userId: 2, role: "admin", email: "admin@email.com" }, secretKey, { expiresIn: "1h" });
...
// curl http://localhost:4000/me -H "Authorization:Bearer <user-token>    "